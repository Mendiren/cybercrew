// Uruchomienie całego skryptu po załadowaniu struktury HTML strony
window.addEventListener('DOMContentLoaded', () => {

    const canvas = document.getElementById('particles-js');
    
    // Jeśli z jakiegoś powodu element canvas nie istnieje, przerwij skrypt
    if (!canvas) {
        console.error('Element canvas #particles-js nie został znaleziony.');
        return;
    }
